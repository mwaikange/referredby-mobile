    ...
    <Layout>
      <div className="flex-1 flex flex-col p-6 font-sans">
        ...
        <div className="flex justify-between items-center mb-4 px-1">
          ...
          <div className="flex items-center gap-2">
            <span className="font-bold text-xs uppercase">Proof of Income</span>
            <div className="w-6 h-6 bg-green-500 rounded-sm"></div>
          </div>
          <div className="flex items-center gap-2">
          ...
          <Settings className="w-6 h-6 text-gray-500 ml-2" />
        </div>

        <div className="text-center text-[11px] text-gray-500 mb-6">
        ...
        <div className="mb-8">
          <Button 
            disabled
            className="w-full bg-gray-200 text-gray-400 font-bold uppercase tracking-wide h-12 rounded-md cursor-not-allowed"
          >
            Update Documents
          </Button>
        </div>
        ...
        <div className="space-y-4 flex-1">
          <Button className="w-full bg-[#0B0B3B] hover:bg-[#151555] text-white font-bold uppercase tracking-wide h-12 shadow-lg rounded-md">
            Request Nano Loan
          </Button>
          <Button className="w-full bg-[#0B0B3B] hover:bg-[#151555] text-white font-bold uppercase tracking-wide h-12 shadow-lg rounded-md">
            Apply for Term Loan
          ...
          <Button 
            ...
            className="w-full bg-red-600 hover:bg-red-700 text-white font-bold uppercase tracking-wide h-12 shadow-lg rounded-md mt-6"
          >
            Sign Out
          </Button>
        </div>
