  ...
  return (
    <Layout>
      <div className="flex-1 flex flex-col px-2">
        ...
        {/* Dark blue panel for selfie capture */}
        <div className="bg-[#0B0B3B] rounded-lg p-4 mb-4">
          <div 
            className="bg-[#1a1a5c] rounded-lg w-full h-40 flex items-center justify-center cursor-pointer mb-4"
          ...
          <div>
            <label className="text-sm text-white mb-2 block">Upload selfie with ID</label>
            <div className="bg-gray-100 rounded-lg px-3 py-2">
              <span className="text-sm text-gray-600" data-testid="text-file-name">
